...
- The final file is the 206 candidate list also maintianted by the NCSBE  [https://www.ncsbe.gov/results-data/candidate-lists  ](https://s3.amazonaws.com/dl.ncsbe.gov/Elections/2026/Candidate%20Filing/Candidate_Listing_2026.csv) 
...
- This left a database comprised of 156 rows. This dataset needs to be checked manually as there can be instances where there may not in fact be a match. You can see those mathces in the candidates_party_change2026.csv file. 
